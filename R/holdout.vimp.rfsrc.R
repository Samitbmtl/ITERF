holdout.vimp.iterf <- function(formula, data,
                               ...
                               ...)
{
  ...
  ##
  ## --------------------------------------------------------------
  ## pull unnamed parameters to pass to iterf
  ...
  p <- length(iterf(formula, data, nodedepth = 1, ntree = 1, splitrule = "random")$xvar.names)
  ...
  o <- do.call(iterf.grow, c(list(formula = formula, data = data, ntree = ntree,
...
holdout.vimp <- holdout.vimp.iterf
## --------------------------------------------------------------
##
