...
Tabib, S. and Larocque, D. (2025). Random Forests for Individual Treatment Effect Estimation with the R Package ITERF. To appear in Computer Methods and Programs in Biomedicine.